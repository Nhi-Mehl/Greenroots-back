...
INSERT INTO "project"
    ("id", "name", "description", "picture", "status", "city", "country", "continent")
VALUES 
    ...
    (3, 'Le vieux continent', 'Le projet européen de reforestation cherche à restaurer les forêts anciennes et à créer de nouveaux espaces boisés pour améliorer la biodiversité et atténuer les effets du changement climatique. Il met l''accent sur l''intégration des forêts dans les paysages ruraux et urbains.', 3, 'Terminé', 'Sarajevo', 'Serbie', 'Europe'),
...
VALUES 
    ...
    (3, 'Palmier dattier', 'Phoenix dactylifera', 'Cultivé pour ses fruits (les dattes), ce palmier est crucial dans les régions arides du Sahara.', 32.50, 3, 5),
    (4, 'Pin ponderosa', 'Pinus ponderosa', 'Un grand pin qui domine les forêts montagneuses de l''ouest des États-Unis.', 45.20, 4, 8),
    (5, 'Cyprès chauve', 'Taxodium distichum', 'Connu pour sa capacité à pousser dans les marécages, notamment dans le sud des États-Unis.', 28.70, 5, 3),
    (6, 'Acacia d''Amérique', 'Prosopis pallida', 'Résistant à la sécheresse, cet arbre est commun dans les régions arides d''Amérique du Sud.', 18.90, 6, 6),
    (7, 'Ipê', 'Handroanthus spp.', 'Un arbre aux fleurs colorées, son bois est très dur et résistant.', 42.00, 7, 7),
    (8, 'Chêne pédonculé', 'Quercus robur', 'Un des arbres les plus anciens et les plus respectés en Europe, utilisé pour le bois et dans les parcs.', 25.50, 8, 4),
    (9, 'Hêtre commun', 'Fagus sylvatica', 'Très répandu dans les forêts européennes, connu pour son bois et ses fruits (faînes).', 38.10, 9, 9),
    (10, 'Cerisiers japonais', 'Prunus serrulata', 'Célèbre pour sa floraison spectaculaire, il est un symbole du Japon.', 49.00, 10, 2),
    (11, 'Eucalyptus', 'Eucalyptus spp.', 'Introduit, il est cultivé dans plusieurs régions pour le bois et l''huile essentielle.', 22.30, 11, 5),
    (12, 'Grevillea', 'Grevillea robusta', 'Un arbre à fleurs jaune vif, souvent utilisé comme ornemental.', 36.70, 12, 7),
    (13, 'Cocotier', 'Cocos nucifera', 'Bien que commun dans les régions tropicales, ce palmier est crucial pour les économies insulaires.', 41.50, 13, 6),
    (14, 'Sequoia géant', 'Sequoiadendron giganteum', 'L''arbre le plus volumineux du monde, emblématique de la Californie.', 50.00, 14, 10),
    (15, 'Baobab', 'Adansonia digitata', 'Arbre emblématique de l''Afrique, connu pour sa longévité et sa capacité à stocker l''eau.', 39.20, 2, 8);
